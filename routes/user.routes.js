...
const { registerUser, loginUser,adminUserdrop,resetChangePassword, sendOtp,createContact,listContact, adminLogin, SubscriberList ,welcome ,adminUserBlock,uploadImage,  resetPassword, forgetPassword,  adminUserDetails, UserDetails, addSubscriber, logout} = require('../controller/user.controller');
...
router.post('/admin/change-password',verifyAdminToken, resetChangePassword); 
